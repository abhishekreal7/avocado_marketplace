        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center gap-3 mb-4">
              <AvocadoLogoMark className="w-10 h-10" />
              <span className="text-2xl font-semibold tracking-tight text-avocado-light">Avocado</span>
            </div>
            <p className="text-gray-300 text-[15px] max-w-md leading-relaxed">
